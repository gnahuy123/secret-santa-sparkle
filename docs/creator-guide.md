...
![Home Page]({{ site.baseurl }}/assets/images/creator_01_home.png)

## Step 2: Add Participants

Enter the names of everyone joining the exchange. You can add as many as you need!

![Filled Form]({{ site.baseurl }}/assets/images/creator_02_filled.png)

## Step 3: Create & Share

Click **Create** and you'll get a unique dashboard with links for every person.

![Room Created]({{ site.baseurl }}/assets/images/creator_03_room_ready.png)
